...
//@*Product categorization sample code from ASP.net core blazor tutorial*@
//@*===================================================================*@
//@*===================================================================*@
using System;
using Microsoft.EntityFrameworkCore;
using ShepherdPOS.Api.Entities;
using ShepherdPOS.Api.Entities.CartItem;
using ShepherdPOS.Api.Entities.Authentication;

namespace ShepherdPOS.Api.Data
{
    public class ShepherdPosDbContext : DbContext
    {
        public ShepherdPosDbContext(DbContextOptions<ShepherdPosDbContext> options) : base(options)
        {
        ...
        public DbSet<Transaction> SaleTransactions { get; set; }
