#nullable enable
using System;
//using ShepherdPOS.Web.CleanArchitecture.Domain.Enums;
using ShepherdPOS.Web.Domain.Contracts;

namespace ShepherdPOS.Web.CleanArchitecture.Domain.Contracts
{
